 ...
 */
export type NavSection = 'home' | 'services' | 'knowledge' | 'contracts' | 'changes' | 'operations' | 'aiHub' | 'governance' | 'organization' | 'integrations' | 'admin';
...
const engineerConfig: PersonaConfig = {
  sectionOrder: ['home', 'services', 'operations', 'changes', 'contracts', 'knowledge', 'organization', 'aiHub', 'governance', 'integrations', 'admin'],
...
const techLeadConfig: PersonaConfig = {
  sectionOrder: ['home', 'services', 'changes', 'operations', 'contracts', 'organization', 'knowledge', 'aiHub', 'governance', 'integrations', 'admin'],
...
const architectConfig: PersonaConfig = {
  sectionOrder: ['home', 'contracts', 'services', 'knowledge', 'organization', 'changes', 'operations', 'governance', 'integrations', 'aiHub', 'admin'],
...
const productConfig: PersonaConfig = {
  sectionOrder: ['home', 'changes', 'services', 'operations', 'organization', 'governance', 'contracts', 'knowledge', 'aiHub', 'integrations', 'admin'],
...
const executiveConfig: PersonaConfig = {
  sectionOrder: ['home', 'governance', 'organization', 'changes', 'services', 'operations', 'contracts', 'knowledge', 'aiHub', 'integrations', 'admin'],
...
const platformAdminConfig: PersonaConfig = {
  sectionOrder: ['home', 'admin', 'organization', 'integrations', 'aiHub', 'governance', 'services', 'contracts', 'knowledge', 'changes', 'operations'],
...
const auditorConfig: PersonaConfig = {
  sectionOrder: ['home', 'governance', 'organization', 'admin', 'changes', 'operations', 'aiHub', 'services', 'contracts', 'knowledge', 'integrations'],

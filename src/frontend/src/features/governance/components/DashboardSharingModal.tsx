...
export function DashboardSharingModal({
  ...
  return (
    <>
      ...
      >
        <div className="bg-card rounded-md shadow-2xl w-full max-w-md">
          {/* Header */}
                    ...
                    <button
                      ...
                      className={`w-full flex items-start gap-3 px-4 py-3 rounded-lg border text-left transition-colors ${
                        isSelected
                          ...
                          : 'border-edge hover:border-gray-300 dark:hover:border-gray-600'
                      }`}
                    >
                      <Icon
                        size={16}
                        className={`mt-0.5 flex-shrink-0 ${isSelected ? 'text-accent' : 'text-faded'}`}
                      />
                      <div className="min-w-0">
                        <p className={`text-sm font-medium ${isSelected ? 'text-accent' : 'text-body'}`}>
                    ...
                    <button
                      ...
                      className={`flex-1 px-3 py-2 rounded-lg border text-sm font-medium transition-colors disabled:opacity-40 disabled:cursor-not-allowed ${
                        permission === perm
                          ...
                          : 'border-edge text-muted hover:border-gray-300'
                      }`}
                    >
                      {t(key, fallback)}
                    </button>

  ...
  return (
    <PageContainer>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-6">
        <SearchInput size="sm" className="flex-1 max-w-xs" value={search} onChange={e => setSearch(e.target.value)} placeholder={t('governancePacks.waivers.searchPlaceholder')} />

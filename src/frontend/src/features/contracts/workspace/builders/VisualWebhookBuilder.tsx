        ...
        <CardBody className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <Field
              ...
              placeholder={t('contracts.builder.webhook.namePlaceholder', 'order-created-webhook')}
              required
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <Field
              ...
              placeholder={t('contracts.builder.webhook.contentTypePlaceholder', 'application/json')}
              disabled={isReadOnly}
            />
            <Field
              ...
              placeholder={t('contracts.builder.webhook.ownerPlaceholder', 'integrations-team')}
              disabled={isReadOnly}
            />
          </div>
          <FieldArea
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            {needsSecretHeader && (
              <Field
                ...
                placeholder={t('contracts.builder.webhook.secretHeaderPlaceholder', 'X-Webhook-Secret')}
                required
                    ...
                    <div className="px-4 pb-4 pt-1 bg-elevated/10 space-y-3">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <Field label={t('contracts.builder.rest.paramName', 'Name')} value={h.name}
                          onChange={(v) => updateHeader(h.id, { name: v })} placeholder={t('contracts.builder.webhook.customHeaderPlaceholder', 'X-Custom-Header')} required disabled={isReadOnly} />
                        <Field label={t('contracts.builder.rest.defaultValue', 'Value')} value={h.value}
                          onChange={(v) => updateHeader(h.id, { value: v })} placeholder={t('contracts.builder.webhook.headerValuePlaceholder', 'header-value')} disabled={isReadOnly} />
                      </div>
        ...
        <CardBody className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <Field
              ...
              placeholder={t('contracts.builder.webhook.retryPolicyPlaceholder', 'exponential-backoff')}
              disabled={isReadOnly}
            />
          </div>
          <FieldTagInput
            ...
            placeholder={t('contracts.builder.webhook.eventsPlaceholder', 'order.created, order.updated')}
          />
          <FieldArea

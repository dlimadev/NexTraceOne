...
/**
 * Workspace de criação de contrato (v5) — orquestrador de 2 colunas.
 * Cartão de identidade vivo à esquerda + tabs (Serviço, Tipo & Modo, Detalhes, Confirmar)
 * à direita. A lógica vive toda no hook `useContractDraftForm`.
 */

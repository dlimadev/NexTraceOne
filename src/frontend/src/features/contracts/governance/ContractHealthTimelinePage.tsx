...
export function ContractHealthTimelinePage() {
  ...
  const handleAnalyze = () => {
    if (!apiAssetId.trim()) return;
    setSubmittedId(apiAssetId.trim());
  };
        ...
        <div className="flex gap-3 flex-wrap">
          <div className="flex-1 min-w-[260px]">
            ...
            <input
              ...
              placeholder={t('contracts.health.placeholder.assetId', 'e.g. 3fa85f64-5717-4562-b3fc-2c963f66afa6')}
          ...
          <div className="flex items-end">
            ...
            >
              {isLoading ? '...' : t('phase4.healthTimeline.version', 'Load Timeline')}
            </button>
          </div>
        </div>
      </div>

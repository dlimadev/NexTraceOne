/** Barrel export — bounded context Product Analytics (adoção, valor, jornadas, personas, tracking). */
export { ProductAnalyticsOverviewPage } from './pages/ProductAnalyticsOverviewPage';
export { ModuleAdoptionPage } from './pages/ModuleAdoptionPage';

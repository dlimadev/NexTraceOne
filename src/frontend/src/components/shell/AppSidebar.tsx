...
const navItems: NavItem[] = [
  ...
  { labelKey: 'sidebar.releases', to: '/releases', icon: <Zap size={18} />, permission: 'change-intelligence:releases:read', section: 'changes' },
  ...
  { labelKey: 'sidebar.maturityScorecards', to: '/governance/maturity', icon: <BarChart3 size={18} />, permission: 'governance:read', section: 'governance' },
  { labelKey: 'sidebar.benchmarking', to: '/governance/benchmarking', icon: <TrendingUp size={18} />, permission: 'governance:read', section: 'governance' },
  ...
  { labelKey: 'sidebar.delegatedAdmin', to: '/governance/delegated-admin', icon: <UserCheck size={18} />, permission: 'governance:read', section: 'organization' },

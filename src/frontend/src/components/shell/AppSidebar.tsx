...
import {
  ...
  Bug, Radio, Flame, TrendingDown, Store, GitFork, FileSearch, Lightbulb,
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { labelKey: 'sidebar.changeAdvisory', to: '/change-advisory', icon: <MessageSquare size={18} />, permission: 'change-intelligence:read', section: 'changes' },
  ...
  { labelKey: 'sidebar.releaseImpactReport', to: '/releases/impact-report', icon: <Target size={18} />, permission: 'change-intelligence:read', section: 'changes', subGroup: 'sidebar.subGroupReleaseLifecycle' },
  { labelKey: 'sidebar.postReleaseReview', to: '/releases/post-review', icon: <Eye size={18} />, permission: 'change-intelligence:read', section: 'changes', subGroup: 'sidebar.subGroupReleaseLifecycle' },
  { labelKey: 'sidebar.releaseNotes', to: '/releases/notes', icon: <BookText size={18} />, permission: 'change-intelligence:read', section: 'changes', subGroup: 'sidebar.subGroupReleaseLifecycle' },
  ...
  { labelKey: 'sidebar.releaseApprovalGateway', to: '/releases/approval-gateway', icon: <Shield size={18} />, permission: 'change-intelligence:write', section: 'changes', subGroup: 'sidebar.subGroupApprovalGovernance' },
  ...
  { labelKey: 'sidebar.requestExplorer', to: '/operations/request-explorer', icon: <Activity size={18} />, permission: 'operations:telemetry:read', section: 'operations' },
  { labelKey: 'sidebar.profilingExplorer', to: '/operations/profiling-explorer', icon: <Cpu size={18} />, permission: 'operations:telemetry:read', section: 'operations' },
  ...
  { labelKey: 'sidebar.dbExplorer', to: '/operations/db-explorer', icon: <HardDrive size={18} />, permission: 'operations:telemetry:read', section: 'operations' },
  { labelKey: 'sidebar.sloBurnRate', to: '/operations/slo-burn-rate', icon: <Flame size={18} />, permission: 'operations:reliability:read', section: 'operations' },
  { labelKey: 'sidebar.postIncident', to: '/operations/post-incident', icon: <FileText size={18} />, permission: 'operations:incidents:read', section: 'operations' },
  { labelKey: 'sidebar.onCallSchedule', to: '/operations/on-call-schedule', icon: <CalendarDays size={18} />, permission: 'operations:incidents:read', section: 'operations' },
  { labelKey: 'sidebar.apiRegression', to: '/operations/api-regression', icon: <TrendingDown size={18} />, permission: 'operations:telemetry:read', section: 'operations' },
  { labelKey: 'sidebar.sloMarketplace', to: '/operations/slo-marketplace', icon: <Store size={18} />, permission: 'operations:reliability:read', section: 'operations' },
  { labelKey: 'sidebar.dependencyRisk', to: '/operations/dependency-risk', icon: <GitFork size={18} />, permission: 'operations:reliability:read', section: 'operations' },
  { labelKey: 'sidebar.loadTesting', to: '/operations/load-testing', icon: <Gauge size={18} />, permission: 'operations:telemetry:read', section: 'operations' },
  { labelKey: 'sidebar.serviceMaturitySre', to: '/operations/service-maturity-sre', icon: <Award size={18} />, permission: 'operations:reliability:read', section: 'operations' },
  { labelKey: 'sidebar.aiAnomaly', to: '/operations/ai-anomaly', icon: <BrainCircuit size={18} />, permission: 'operations:runtime:read', section: 'operations' },
  { labelKey: 'sidebar.aiIncidentSummarizer', to: '/operations/ai-incident-summarizer', icon: <FileSearch size={18} />, permission: 'operations:incidents:read', section: 'operations' },
  { labelKey: 'sidebar.aiRunbookSuggester', to: '/operations/ai-runbook-suggester', icon: <Lightbulb size={18} />, permission: 'operations:runbooks:read', section: 'operations' },
  ...
  { labelKey: 'sidebar.finopsConfiguration', to: '/governance/finops/configuration', icon: <Settings size={18} />, permission: 'governance:finops:read', section: 'governance' },
  { labelKey: 'sidebar.finopsBudgetApprovals', to: '/governance/finops/approvals', icon: <ClipboardCheck size={18} />, permission: 'governance:finops:read', section: 'governance' },
  ...
  { labelKey: 'sidebar.platformAlertRules', to: '/admin/platform-alerts', icon: <Bell size={18} />, permission: 'platform:admin:read', section: 'admin' },
  { labelKey: 'sidebar.recoveryWizard', to: '/admin/recovery', icon: <RotateCcw size={18} />, permission: 'platform:admin:read', section: 'admin' },
  { labelKey: 'sidebar.greenOps', to: '/admin/greenops', icon: <Leaf size={18} />, permission: 'platform:admin:read', section: 'admin' },

...
import {
  ...
  RotateCcw, GitMerge, Mail, GitBranch,
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { labelKey: 'sidebar.ownershipTransfer', to: '/services/ownership-transfer', icon: <UserCheck size={18} />, permission: 'catalog:assets:write', section: 'services' },
  { labelKey: 'sidebar.orphanServices', to: '/services/orphan-services', icon: <AlertTriangle size={18} />, permission: 'catalog:assets:read', section: 'services' },
  { labelKey: 'sidebar.serviceChangelog', to: '/services/changelog', icon: <Clock size={18} />, permission: 'catalog:assets:read', section: 'services' },
  ...
  { labelKey: 'sidebar.contractLifecyclePolicy', to: '/contracts/lifecycle-policy', icon: <CalendarDays size={18} />, permission: 'contracts:write', section: 'contracts' },
  { labelKey: 'sidebar.rollbackIntelligence', to: '/changes/rollback-intelligence', icon: <RotateCcw size={18} />, permission: 'change-intelligence:read', section: 'changes' },
  { labelKey: 'sidebar.changeIncidentCorrelation', to: '/changes/incident-correlation', icon: <GitMerge size={18} />, permission: 'change-intelligence:read', section: 'changes' },
  { labelKey: 'sidebar.incidentPostMortem', to: '/operations/incident-post-mortem', icon: <FileText size={18} />, permission: 'operations:incidents:write', section: 'operations' },
  { labelKey: 'sidebar.operationalPlaybook', to: '/operations/playbook-builder', icon: <ClipboardList size={18} />, permission: 'operations:runbooks:write', section: 'operations' },
  { labelKey: 'sidebar.configurationDrift', to: '/operations/configuration-drift', icon: <GitBranch size={18} />, permission: 'operations:runtime:read', section: 'operations' },
  { labelKey: 'sidebar.aiChangeImpact', to: '/ai/change-impact-advisor', icon: <Zap size={18} />, permission: 'ai:assistant:read', section: 'aiHub' },
  { labelKey: 'sidebar.aiContractGenerator', to: '/ai/contract-generator', icon: <FileCode size={18} />, permission: 'ai:assistant:read', section: 'aiHub' },
  { labelKey: 'sidebar.aiRunbookCopilot', to: '/ai/runbook-copilot', icon: <Bot size={18} />, permission: 'ai:assistant:read', section: 'aiHub' },
  { labelKey: 'sidebar.aiKnowledgeExtraction', to: '/ai/knowledge-extraction', icon: <BrainCircuit size={18} />, permission: 'ai:assistant:read', section: 'aiHub' },
  { labelKey: 'sidebar.aiTestScenario', to: '/ai/test-scenario-generator', icon: <CheckSquare size={18} />, permission: 'ai:assistant:read', section: 'aiHub' },
  { labelKey: 'sidebar.executiveDigest', to: '/governance/executive-digest', icon: <Mail size={18} />, permission: 'governance:reports:read', section: 'governance' },

 ...
 *
 * Estado ativo (expandido): fundo accent/10 translúcido + texto accent. Padrão Strato.
 * Estado ativo (collapsed): fundo accent/10 translúcido + ícone accent.
  ...
  if (collapsed) {
    return (
      <NavLink
        ...
        className={({ isActive }) =>
          cn(
            'relative flex items-center justify-center w-11 h-10 mx-auto rounded-[3px] mb-0.5',
  ...
  return (
    <li>
      <NavLink
        ...
        className={({ isActive }) =>
          cn(
            'flex items-center gap-2.5 px-3 py-1.5 rounded-[3px] text-sm',

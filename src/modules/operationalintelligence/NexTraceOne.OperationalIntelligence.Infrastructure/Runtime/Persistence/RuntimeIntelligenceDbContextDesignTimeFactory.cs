...
/// </summary>
internal sealed class RuntimeIntelligenceDbContextDesignTimeFactory : IDesignTimeDbContextFactory<RuntimeIntelligenceDbContext>
{
    public RuntimeIntelligenceDbContext CreateDbContext(string[] args)
    {

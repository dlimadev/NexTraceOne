...
{
    /// <inheritdoc />
    public partial class AddNotificationsEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // ── Notifications tables (from NotificationsDbContext) ─────────────────
            ...
            // ── Indexes for ntf_notifications ──────────────────────────────────────
            migrationBuilder.CreateIndex(name: "IX_ntf_notifications_TenantId", table: "ntf_notifications", column: "TenantId");
            migrationBuilder.CreateIndex(name: "IX_ntf_notifications_RecipientUserId", table: "ntf_notifications", column: "RecipientUserId");
            migrationBuilder.CreateIndex(name: "IX_ntf_notifications_Status", table: "ntf_notifications", column: "Status");
            migrationBuilder.CreateIndex(name: "IX_ntf_notifications_CreatedAt", table: "ntf_notifications", column: "CreatedAt");
            migrationBuilder.CreateIndex(name: "IX_ntf_notifications_RecipientUserId_Status", table: "ntf_notifications", columns: ["RecipientUserId", "Status"]);

            // ── Indexes for ntf_deliveries ─────────────────────────────────────────
            migrationBuilder.CreateIndex(name: "IX_ntf_deliveries_NotificationId", table: "ntf_deliveries", column: "NotificationId");
            migrationBuilder.CreateIndex(name: "IX_ntf_deliveries_Status", table: "ntf_deliveries", column: "Status");
            migrationBuilder.CreateIndex(name: "IX_ntf_deliveries_Channel", table: "ntf_deliveries", column: "Channel");
            migrationBuilder.CreateIndex(name: "IX_ntf_deliveries_Status_RetryCount", table: "ntf_deliveries", columns: ["Status", "RetryCount"]);
            migrationBuilder.CreateIndex(name: "IX_ntf_deliveries_Status_NextRetryAt", table: "ntf_deliveries", columns: ["Status", "NextRetryAt"]);

            // ── Indexes for ntf_channel_configurations ────────────────────────────
            migrationBuilder.CreateIndex(name: "IX_ntf_channel_configurations_TenantId", table: "ntf_channel_configurations", column: "TenantId");
            migrationBuilder.CreateIndex(name: "IX_ntf_channel_configurations_TenantId_ChannelType", table: "ntf_channel_configurations", columns: ["TenantId", "ChannelType"], unique: true);

            // ── Indexes for ntf_preferences ────────────────────────────────────────
            migrationBuilder.CreateIndex(name: "IX_ntf_preferences_TenantId", table: "ntf_preferences", column: "TenantId");
            migrationBuilder.CreateIndex(name: "IX_ntf_preferences_UserId", table: "ntf_preferences", column: "UserId");
            migrationBuilder.CreateIndex(name: "IX_ntf_preferences_TenantId_UserId_Category_Channel", table: "ntf_preferences", columns: ["TenantId", "UserId", "Category", "Channel"], unique: true);

            // ── Indexes for ntf_smtp_configurations ────────────────────────────────
            migrationBuilder.CreateIndex(name: "IX_ntf_smtp_configurations_TenantId", table: "ntf_smtp_configurations", column: "TenantId", unique: true);

            // ── Indexes for ntf_templates ──────────────────────────────────────────
            migrationBuilder.CreateIndex(name: "IX_ntf_templates_TenantId", table: "ntf_templates", column: "TenantId");
            migrationBuilder.CreateIndex(name: "IX_ntf_templates_EventType", table: "ntf_templates", column: "EventType");
            migrationBuilder.CreateIndex(name: "IX_ntf_templates_IsActive", table: "ntf_templates", column: "IsActive");
            migrationBuilder.CreateIndex(name: "IX_ntf_templates_TenantId_EventType_Channel_Locale", table: "ntf_templates", columns: ["TenantId", "EventType", "Channel", "Locale"]);
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "ntf_deliveries");
            migrationBuilder.DropTable(name: "ntf_channel_configurations");
            migrationBuilder.DropTable(name: "ntf_preferences");
            migrationBuilder.DropTable(name: "ntf_smtp_configurations");
            migrationBuilder.DropTable(name: "ntf_templates");
            migrationBuilder.DropTable(name: "ntf_notifications");
        }
    }
}

...
/// </summary>
internal sealed class ConfigurationDbContextDesignTimeFactory : IDesignTimeDbContextFactory<ConfigurationDbContext>
{
    /// <summary>Cria instância do ConfigurationDbContext configurada para geração de migrations.</summary>
    public ConfigurationDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseNpgsql(connectionString,
            npgsql => npgsql.MigrationsAssembly(typeof(ConfigurationDbContext).Assembly.FullName));

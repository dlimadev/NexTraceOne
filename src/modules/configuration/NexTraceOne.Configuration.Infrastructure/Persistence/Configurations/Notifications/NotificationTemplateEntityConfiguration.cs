...
/// </summary>
internal sealed class NotificationTemplateEntityConfiguration : IEntityTypeConfiguration<NotificationTemplate>
{
    public void Configure(EntityTypeBuilder<NotificationTemplate> builder)
    {
        ...
        builder.Property(x => x.PlainTextTemplate).HasColumnType("text");
        builder.Property(x => x.Channel).HasConversion<string>().HasMaxLength(100);

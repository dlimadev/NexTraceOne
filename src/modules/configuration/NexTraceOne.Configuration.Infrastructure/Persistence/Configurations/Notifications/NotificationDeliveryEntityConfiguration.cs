...
namespace NexTraceOne.Configuration.Infrastructure.Persistence.Configurations.Notifications;

/// <summary>
/// Configura o mapeamento da entidade NotificationDelivery para a tabela ntf_deliveries.
/// </summary>
internal sealed class NotificationDeliveryEntityConfiguration : IEntityTypeConfiguration<NotificationDelivery>
{
    public void Configure(EntityTypeBuilder<NotificationDelivery> builder)
    {
        ...
        builder.Property(x => x.Channel).HasConversion<string>().HasMaxLength(100).IsRequired();
        ...
        builder.Property(x => x.DeliveredAt).HasColumnType("timestamp with time zone");

    ...
    : IEntityTypeConfiguration<SmtpConfiguration>
{
    public void Configure(EntityTypeBuilder<SmtpConfiguration> builder)
    {
        ...
        builder.Property(x => x.Host).HasMaxLength(500).IsRequired();
        builder.Property(x => x.Port).IsRequired();
        builder.Property(x => x.UseSsl).IsRequired();
        builder.Property(x => x.Username).HasMaxLength(500);
        builder.Property(x => x.EncryptedPassword).HasMaxLength(4000);
        builder.Property(x => x.FromAddress).HasMaxLength(500).IsRequired();
        builder.Property(x => x.FromName).HasMaxLength(200).IsRequired();
        builder.Property(x => x.BaseUrl).HasMaxLength(2000);

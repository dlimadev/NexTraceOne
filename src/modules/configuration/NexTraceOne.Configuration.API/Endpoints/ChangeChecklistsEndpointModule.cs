...
/// <summary>Endpoints de checklists de mudança customizáveis por tenant.</summary>
public sealed class ChangeChecklistsEndpointModule
{
    public static void MapEndpoints(IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/api/v1/change-checklists").RequireAuthorization();

...
namespace NexTraceOne.AIKnowledge.Infrastructure.Orchestration.Persistence.Migrations
{
    ...
    [Migration("20260531161937_SyncModelChanges")]
            ...
            modelBuilder.Entity("NexTraceOne.AIKnowledge.Domain.Orchestration.Entities.AgentWorkflowExecution", b =>
                {
                    ...
                    b.ToTable("aik_orch_workflow_executions", (string)null);
                });
            ...
            modelBuilder.Entity("NexTraceOne.BuildingBlocks.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("aik_outbox_messages", (string)null);
                });

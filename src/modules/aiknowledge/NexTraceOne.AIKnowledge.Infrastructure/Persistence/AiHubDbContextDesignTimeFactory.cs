...
/// <summary>
/// Design-time factory para EF Core migrations do AiHubDbContext.
/// </summary>
internal sealed class AiHubDbContextDesignTimeFactory : IDesignTimeDbContextFactory<AiHubDbContext>
{
    public AiHubDbContext CreateDbContext(string[] args)
    {
        var optionsBuilder = new DbContextOptionsBuilder<AiHubDbContext>();
        ...
        optionsBuilder.UseNpgsql(connectionString,
            npgsql => npgsql.MigrationsAssembly(typeof(AiHubDbContext).Assembly.FullName));

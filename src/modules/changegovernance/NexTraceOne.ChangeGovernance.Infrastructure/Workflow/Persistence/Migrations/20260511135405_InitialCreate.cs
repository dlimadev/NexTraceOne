    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_approval_decisions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "chg_evidence_packs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkflowInstanceId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    PipelineSource = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    BuildId = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CommitSha = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CiChecksResult = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    IntegritySignedBy = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_evidence_packs", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "chg_sla_policies",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_sla_policies", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "chg_wf_outbox_messages",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_wf_outbox_messages", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "chg_workflow_instances",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkflowTemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_workflow_instances", x => x.Id);
                    table.CheckConstraint("CK_chg_workflow_instances_status", "\"Status\" IN ('Draft', 'Pending', 'InReview', 'Approved', 'Rejected', 'Cancelled')");
                });

            migrationBuilder.CreateTable(
                name: "chg_workflow_stages",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkflowInstanceId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_workflow_stages", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "chg_workflow_templates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_workflow_templates", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_chg_approval_decisions_WorkflowInstanceId",
                table: "chg_approval_decisions",
                column: "WorkflowInstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_chg_approval_decisions_WorkflowStageId",
                table: "chg_approval_decisions",
                column: "WorkflowStageId");

            migrationBuilder.CreateIndex(
                name: "IX_chg_evidence_packs_ReleaseId",
                table: "chg_evidence_packs",
                column: "ReleaseId");

            migrationBuilder.CreateIndex(
                name: "IX_chg_evidence_packs_WorkflowInstanceId",
                table: "chg_evidence_packs",
                column: "WorkflowInstanceId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_chg_sla_policies_WorkflowTemplateId",
                table: "chg_sla_policies",
                column: "WorkflowTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_chg_sla_policies_WorkflowTemplateId_StageName",
                table: "chg_sla_policies",
                columns: new[] { "WorkflowTemplateId", "StageName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_chg_wf_outbox_messages_CreatedAt",
                table: "chg_wf_outbox_messages",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_chg_wf_outbox_messages_IdempotencyKey",
                table: "chg_wf_outbox_messages",
                column: "IdempotencyKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_chg_wf_outbox_messages_ProcessedAt",
                table: "chg_wf_outbox_messages",
                column: "ProcessedAt");

            migrationBuilder.CreateIndex(
                name: "IX_chg_workflow_instances_ReleaseId",
                table: "chg_workflow_instances",
                column: "ReleaseId");

            migrationBuilder.CreateIndex(
                name: "IX_chg_workflow_instances_Status",
                table: "chg_workflow_instances",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_chg_workflow_instances_WorkflowTemplateId",
                table: "chg_workflow_instances",
                column: "WorkflowTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_chg_workflow_stages_WorkflowInstanceId",
                table: "chg_workflow_stages",
                column: "WorkflowInstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_chg_workflow_stages_WorkflowInstanceId_StageOrder",
                table: "chg_workflow_stages",
                columns: new[] { "WorkflowInstanceId", "StageOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_chg_workflow_templates_ChangeType",
                table: "chg_workflow_templates",
                column: "ChangeType");

            migrationBuilder.CreateIndex(
                name: "IX_chg_workflow_templates_IsActive",
                table: "chg_workflow_templates",
                column: "IsActive");
        }

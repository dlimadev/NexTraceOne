    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_lint_results", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "chg_rg_outbox_messages",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_rg_outbox_messages", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "chg_ruleset_bindings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RulesetId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_ruleset_bindings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_chg_rulesets", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_chg_lint_results_ReleaseId",
                table: "chg_lint_results",
                column: "ReleaseId");

            migrationBuilder.CreateIndex(
                name: "IX_chg_rg_outbox_messages_CreatedAt",
                table: "chg_rg_outbox_messages",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_chg_rg_outbox_messages_IdempotencyKey",
                table: "chg_rg_outbox_messages",
                column: "IdempotencyKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_chg_rg_outbox_messages_ProcessedAt",
                table: "chg_rg_outbox_messages",
                column: "ProcessedAt");

            migrationBuilder.CreateIndex(
                name: "IX_chg_ruleset_bindings_RulesetId_AssetType",
                table: "chg_ruleset_bindings",

...
/// </summary>
internal sealed class RulesetGovernanceDbContextDesignTimeFactory : IDesignTimeDbContextFactory<RulesetGovernanceDbContext>
{
    /// <summary>Cria instância do RulesetGovernanceDbContext configurada para geração de migrations.</summary>
    public RulesetGovernanceDbContext CreateDbContext(string[] args)
    {
        var optionsBuilder = new DbContextOptionsBuilder<RulesetGovernanceDbContext>();
        ...
        optionsBuilder.UseNpgsql(connectionString,
            npgsql => npgsql.MigrationsAssembly(typeof(RulesetGovernanceDbContext).Assembly.FullName));

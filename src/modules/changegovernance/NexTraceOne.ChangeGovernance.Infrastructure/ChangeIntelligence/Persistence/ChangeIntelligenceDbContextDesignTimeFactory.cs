...
/// </summary>
internal sealed class ChangeIntelligenceDbContextDesignTimeFactory : IDesignTimeDbContextFactory<ChangeIntelligenceDbContext>
{
    /// <summary>Cria instância do ChangeIntelligenceDbContext configurada para geração de migrations.</summary>
    public ChangeIntelligenceDbContext CreateDbContext(string[] args)
    {

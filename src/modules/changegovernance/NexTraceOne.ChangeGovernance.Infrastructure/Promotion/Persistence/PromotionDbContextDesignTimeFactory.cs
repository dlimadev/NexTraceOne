...
/// </summary>
internal sealed class PromotionDbContextDesignTimeFactory : IDesignTimeDbContextFactory<PromotionDbContext>
{
    /// <summary>Cria instância do PromotionDbContext configurada para geração de migrations.</summary>

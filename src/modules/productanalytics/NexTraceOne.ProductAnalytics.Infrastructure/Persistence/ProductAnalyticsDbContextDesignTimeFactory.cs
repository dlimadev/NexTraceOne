...
/// </summary>
internal sealed class ProductAnalyticsDbContextDesignTimeFactory : IDesignTimeDbContextFactory<ProductAnalyticsDbContext>
{
    /// <summary>Cria instância do ProductAnalyticsDbContext configurada para geração de migrations.</summary>
    public ProductAnalyticsDbContext CreateDbContext(string[] args)
    {
        var optionsBuilder = new DbContextOptionsBuilder<ProductAnalyticsDbContext>();
        ...
        optionsBuilder.UseNpgsql(connectionString,
            npgsql => npgsql.MigrationsAssembly(typeof(ProductAnalyticsDbContext).Assembly.FullName));

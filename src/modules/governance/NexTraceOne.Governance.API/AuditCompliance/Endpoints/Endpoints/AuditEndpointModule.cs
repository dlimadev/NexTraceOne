...
using CreateAuditCampaignFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.CreateAuditCampaign.CreateAuditCampaign;
using CreateCompliancePolicyFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.CreateCompliancePolicy.CreateCompliancePolicy;
using ExportAuditReportFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.ExportAuditReport.ExportAuditReport;
using GetAuditCampaignFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.GetAuditCampaign.GetAuditCampaign;
using GetAuditTrailFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.GetAuditTrail.GetAuditTrail;
using GetCompliancePolicyFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.GetCompliancePolicy.GetCompliancePolicy;
using GetComplianceReportFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.GetComplianceReport.GetComplianceReport;
using GetRetentionPoliciesFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.GetRetentionPolicies.GetRetentionPolicies;
using ListAuditCampaignsFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.ListAuditCampaigns.ListAuditCampaigns;
using ListCompliancePoliciesFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.ListCompliancePolicies.ListCompliancePolicies;
using ListComplianceResultsFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.ListComplianceResults.ListComplianceResults;
using ApplyRetentionFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.ApplyRetention.ApplyRetention;
using ConfigureRetentionFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.ConfigureRetention.ConfigureRetention;
using RecordAuditEventFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.RecordAuditEvent.RecordAuditEvent;
using RecordComplianceResultFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.RecordComplianceResult.RecordComplianceResult;
using SearchAuditLogFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.SearchAuditLog.SearchAuditLog;
using VerifyChainIntegrityFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.VerifyChainIntegrity.VerifyChainIntegrity;
using GetComplianceFrameworkSummaryFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.GetComplianceFrameworkSummary.GetComplianceFrameworkSummary;
using EvaluateContinuousComplianceFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.EvaluateContinuousCompliance.EvaluateContinuousCompliance;
using GetComplianceDashboardFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.GetComplianceDashboard.GetComplianceDashboard;
using ExportComplianceEvidencesFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.ExportComplianceEvidences.ExportComplianceEvidences;
using GenerateAuditReadyReportFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.GenerateAuditReadyReport.GenerateAuditReadyReport;
using UpdateCompliancePolicyFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.UpdateCompliancePolicy.UpdateCompliancePolicy;
using ActivateCompliancePolicyFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.ActivateCompliancePolicy.ActivateCompliancePolicy;
using DeactivateCompliancePolicyFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.DeactivateCompliancePolicy.DeactivateCompliancePolicy;
using TransitionAuditCampaignFeature = NexTraceOne.Governance.Application.AuditCompliance.Features.TransitionAuditCampaign.TransitionAuditCampaign;

namespace NexTraceOne.Governance.API.AuditCompliance.Endpoints.Endpoints;

...
namespace NexTraceOne.Governance.Application.AuditCompliance.Features.TransitionAuditCampaign;
...
public static class TransitionAuditCampaign
{
        ...
        IAuditComplianceUnitOfWork unitOfWork) : ICommandHandler<Command, Response>
    {
        public async Task<Result<Response>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var campaignId = NexTraceOne.Governance.Domain.AuditCompliance.Entities.AuditCampaignId.From(request.CampaignId);

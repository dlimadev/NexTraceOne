...
using NexTraceOne.Governance.Application.AuditCompliance.Features.GetComplianceFrameworkSummary;
using NexTraceOne.Governance.Domain.AuditCompliance.Enums;
using NexTraceOne.BuildingBlocks.Application.Abstractions;
using NexTraceOne.BuildingBlocks.Application.Cqrs;
using NexTraceOne.BuildingBlocks.Core.Results;

namespace NexTraceOne.Governance.Application.AuditCompliance.Features.ExportComplianceEvidences;

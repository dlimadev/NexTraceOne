...
namespace NexTraceOne.Governance.Application.AuditCompliance.Features.UpdateCompliancePolicy;
...
public static class UpdateCompliancePolicy
{
        ...
        IAuditComplianceUnitOfWork unitOfWork) : ICommandHandler<Command, Response>
    {
        public async Task<Result<Response>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var policyId = NexTraceOne.Governance.Domain.AuditCompliance.Entities.CompliancePolicyId.From(request.PolicyId);
            ...
            if (!Enum.TryParse<NexTraceOne.Governance.Domain.AuditCompliance.Enums.ComplianceSeverity>(request.Severity, ignoreCase: true, out var severity))
                return AuditErrors.CompliancePolicyNotFound(request.PolicyId);

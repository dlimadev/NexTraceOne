...
{
    /// <inheritdoc />
    public partial class W02_DependencyGovernanceFoundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_dep_package_dependencies_dep_service_dependency_profiles_ProfileId",
        ...
        {
            migrationBuilder.DropTable(name: "dep_outbox_messages");
            migrationBuilder.DropTable(name: "dep_package_dependencies");
            migrationBuilder.DropTable(name: "dep_service_dependency_profiles");
        }
    }
}

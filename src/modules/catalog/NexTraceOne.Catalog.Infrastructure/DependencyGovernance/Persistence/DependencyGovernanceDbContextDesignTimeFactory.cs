...
/// </summary>
internal sealed class DependencyGovernanceDbContextDesignTimeFactory : IDesignTimeDbContextFactory<DependencyGovernanceDbContext>
{
    /// <summary>Cria instância do DependencyGovernanceDbContext configurada para geração de migrations.</summary>
    public DependencyGovernanceDbContext CreateDbContext(string[] args)
    {
        var optionsBuilder = new DbContextOptionsBuilder<DependencyGovernanceDbContext>();
        ...
        optionsBuilder.UseNpgsql(connectionString,
            npgsql => npgsql.MigrationsAssembly(typeof(DependencyGovernanceDbContext).Assembly.FullName));

        return new DependencyGovernanceDbContext(

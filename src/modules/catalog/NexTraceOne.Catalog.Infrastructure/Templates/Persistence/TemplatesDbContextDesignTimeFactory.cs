...
{
    /// <summary>Cria instância do TemplatesDbContext configurada para geração de migrations.</summary>
    public TemplatesDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseNpgsql(connectionString,
            npgsql => npgsql.MigrationsAssembly(typeof(TemplatesDbContext).Assembly.FullName));

...
/// <summary>
/// Adiciona um índice GIN de full-text search sobre a tabela cat_contract_versions.
...
public partial class AddContractVersionFtsIndex : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            @"CREATE INDEX IF NOT EXISTS ""IX_cat_contract_versions_fts"" 
              ON ""cat_contract_versions"" 
    ...
    {
        migrationBuilder.Sql(@"DROP INDEX IF EXISTS ""IX_cat_contract_versions_fts""");
    }
}

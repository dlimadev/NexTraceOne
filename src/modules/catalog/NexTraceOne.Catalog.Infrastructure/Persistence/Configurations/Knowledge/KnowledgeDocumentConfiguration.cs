...
internal sealed class KnowledgeDocumentConfiguration : IEntityTypeConfiguration<KnowledgeDocument>
{
    public void Configure(EntityTypeBuilder<KnowledgeDocument> builder)
    {
        ...
        builder.Property(x => x.FreshnessScore).HasColumnName("freshness_score").HasDefaultValue(100);
        builder.Property(x => x.LastReviewedAt).HasColumnName("last_reviewed_at").HasColumnType("timestamp with time zone");

...
/// </summary>
internal sealed class DeveloperExperienceDbContextDesignTimeFactory : IDesignTimeDbContextFactory<DeveloperExperienceDbContext>
{
    /// <summary>Cria instância do DeveloperExperienceDbContext configurada para geração de migrations.</summary>
    public DeveloperExperienceDbContext CreateDbContext(string[] args)
    {
        var optionsBuilder = new DbContextOptionsBuilder<DeveloperExperienceDbContext>();
        ...
        optionsBuilder.UseNpgsql(connectionString,
            npgsql => npgsql.MigrationsAssembly(typeof(DeveloperExperienceDbContext).Assembly.FullName));

        return new DeveloperExperienceDbContext(

    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dx_ide_usage_records", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_dx_ide_usage_records_TenantId",
                table: "dx_ide_usage_records",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_dx_ide_usage_records_TenantId_OccurredAt",
                table: "dx_ide_usage_records",
                columns: new[] { "TenantId", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_dx_ide_usage_records_UserId_OccurredAt",
                table: "dx_ide_usage_records",

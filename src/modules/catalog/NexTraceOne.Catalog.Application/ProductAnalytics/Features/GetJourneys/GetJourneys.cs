...
using NexTraceOne.Catalog.Application.ProductAnalytics.ConfigurationKeys;
using NexTraceOne.Catalog.Application.ProductAnalytics.Constants;
using NexTraceOne.Catalog.Domain.ProductAnalytics.Enums;
using System.Text.Json;
using NexTraceOne.Catalog.Application.ProductAnalytics;

namespace NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetJourneys;
...
public static class GetJourneys
{
        ...
        ICurrentTenant tenant) : IQueryHandler<Query, Response>
    {
        ...
        /// </summary>
        private static JourneyDefinition? ParseDbDefinition(NexTraceOne.Catalog.Domain.ProductAnalytics.Entities.JourneyDefinition dbDef)
        {
            try
            {

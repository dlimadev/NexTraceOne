...
namespace NexTraceOne.Catalog.Application.Knowledge.Features.GenerateAutoDocumentation;
...
public static class GenerateAutoDocumentation
{
        ...
        IDateTimeProvider clock) : IQueryHandler<Query, Response>
    {
        ...
        public async Task<Result<Response>> Handle(Query request, CancellationToken cancellationToken)
        {
            ...
            var (runbooks, _) = await documentRepository.ListAsync(Domain.Knowledge.Enums.DocumentCategory.Runbook, null, 1, 20, cancellationToken);
        ...
        private static DocSection GenerateSection(
            string section,
            string serviceName,
            IReadOnlyList<Domain.Knowledge.Entities.KnowledgeDocument> runbooks,

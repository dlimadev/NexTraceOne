...
using CreateKnowledgeDocumentFeature = NexTraceOne.Catalog.Application.Knowledge.Features.CreateKnowledgeDocument.CreateKnowledgeDocument;
using CreateOperationalNoteFeature = NexTraceOne.Catalog.Application.Knowledge.Features.CreateOperationalNote.CreateOperationalNote;
using CreateKnowledgeRelationFeature = NexTraceOne.Catalog.Application.Knowledge.Features.CreateKnowledgeRelation.CreateKnowledgeRelation;
using GetKnowledgeByRelationTargetFeature = NexTraceOne.Catalog.Application.Knowledge.Features.GetKnowledgeByRelationTarget.GetKnowledgeByRelationTarget;
using GetKnowledgeRelationsBySourceFeature = NexTraceOne.Catalog.Application.Knowledge.Features.GetKnowledgeRelationsBySource.GetKnowledgeRelationsBySource;
using ListKnowledgeDocumentsFeature = NexTraceOne.Catalog.Application.Knowledge.Features.ListKnowledgeDocuments.ListKnowledgeDocuments;
using GetKnowledgeDocumentByIdFeature = NexTraceOne.Catalog.Application.Knowledge.Features.GetKnowledgeDocumentById.GetKnowledgeDocumentById;
using ListOperationalNotesFeature = NexTraceOne.Catalog.Application.Knowledge.Features.ListOperationalNotes.ListOperationalNotes;
using UpdateKnowledgeDocumentFeature = NexTraceOne.Catalog.Application.Knowledge.Features.UpdateKnowledgeDocument.UpdateKnowledgeDocument;
using UpdateOperationalNoteFeature = NexTraceOne.Catalog.Application.Knowledge.Features.UpdateOperationalNote.UpdateOperationalNote;
using GetKnowledgeGraphOverviewFeature = NexTraceOne.Catalog.Application.Knowledge.Features.GetKnowledgeGraphOverview.GetKnowledgeGraphOverview;
using GenerateAutoDocumentationFeature = NexTraceOne.Catalog.Application.Knowledge.Features.GenerateAutoDocumentation.GenerateAutoDocumentation;
using GetServiceOperationalTimelineFeature = NexTraceOne.Catalog.Application.Knowledge.Features.GetServiceOperationalTimeline.GetServiceOperationalTimeline;
...
public sealed class KnowledgeEndpointModule
{
    ...
    public static void MapEndpoints(IEndpointRouteBuilder app)
    {
        ...
        knowledge.MapGet("/relations/by-target/{targetType}/{targetEntityId:guid}", async (
            ...
            CancellationToken cancellationToken) =>
        {
            if (!Enum.TryParse<NexTraceOne.Catalog.Domain.Knowledge.Enums.RelationType>(targetType, true, out var parsedType))
            {

...
using RecordAnalyticsEventFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.RecordAnalyticsEvent.RecordAnalyticsEvent;
using GetAnalyticsSummaryFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetAnalyticsSummary.GetAnalyticsSummary;
using GetModuleAdoptionFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetModuleAdoption.GetModuleAdoption;
using GetPersonaUsageFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetPersonaUsage.GetPersonaUsage;
using GetJourneysFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetJourneys.GetJourneys;
using GetValueMilestonesFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetValueMilestones.GetValueMilestones;
using GetFrictionIndicatorsFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetFrictionIndicators.GetFrictionIndicators;
using GetAdoptionFunnelFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetAdoptionFunnel.GetAdoptionFunnel;
using GetFeatureHeatmapFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetFeatureHeatmap.GetFeatureHeatmap;
using ExportAnalyticsDataFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.ExportAnalyticsData.ExportAnalyticsData;
using GetCohortAnalysisFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.GetCohortAnalysis.GetCohortAnalysis;
using ListJourneyDefinitionsFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.ListJourneyDefinitions.ListJourneyDefinitions;
using CreateJourneyDefinitionFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.CreateJourneyDefinition.CreateJourneyDefinition;
using UpdateJourneyDefinitionFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.UpdateJourneyDefinition.UpdateJourneyDefinition;
using DeleteJourneyDefinitionFeature = NexTraceOne.Catalog.Application.ProductAnalytics.Features.DeleteJourneyDefinition.DeleteJourneyDefinition;

namespace NexTraceOne.Catalog.API.ProductAnalytics.Endpoints;

...
/// </summary>
internal sealed class IntegrationsDbContextDesignTimeFactory : IDesignTimeDbContextFactory<IntegrationsDbContext>
{
    /// <summary>Cria instância do IntegrationsDbContext configurada para geração de migrations.</summary>
    public IntegrationsDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseNpgsql(connectionString,
            npgsql => npgsql.MigrationsAssembly(typeof(IntegrationsDbContext).Assembly.FullName));

        return new IntegrationsDbContext(

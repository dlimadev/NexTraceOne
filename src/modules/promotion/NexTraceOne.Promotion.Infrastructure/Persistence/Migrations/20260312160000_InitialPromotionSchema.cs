...
namespace NexTraceOne.Promotion.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialPromotionSchema : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "prm_gate_evaluations");
            migrationBuilder.DropTable(name: "prm_promotion_gates");
            migrationBuilder.DropTable(name: "prm_promotion_requests");
            migrationBuilder.DropTable(name: "prm_deployment_environments");

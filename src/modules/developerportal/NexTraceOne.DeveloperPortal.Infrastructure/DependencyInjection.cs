...
/// Inclui: DbContext com interceptors (auditoria + RLS), repositórios e serviços de integração.
/// </summary>
public static class DependencyInjection
{
    /// <summary>
    /// Adiciona infraestrutura do DeveloperPortal ao contentor de DI.
    /// Segue o padrão dos demais módulos: Building Blocks → Connection String → DbContext → UoW → Repos.
    /// </summary>

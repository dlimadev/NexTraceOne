...
public sealed class SelectTenantTests
{
    ...
    {
        var user = User.CreateLocal(Email.Create("alice@test.com"), FullName.Create("Alice", "Doe"), HashedPassword.FromPlainText("P@ssw0rd123!"), DateTimeOffset.UtcNow);
    ...
    {
        var user = User.CreateLocal(Email.Create("dave@test.com"), FullName.Create("Dave", "Smith"), HashedPassword.FromPlainText("P@ssw0rd123!"), DateTimeOffset.UtcNow);
    ...
    {
        var user = User.CreateLocal(Email.Create("eve@test.com"), FullName.Create("Eve", "Jones"), HashedPassword.FromPlainText("P@ssw0rd123!"), DateTimeOffset.UtcNow);

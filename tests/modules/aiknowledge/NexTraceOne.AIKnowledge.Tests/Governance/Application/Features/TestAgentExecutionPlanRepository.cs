...
/// <summary>
/// Implementação em memória do repositório de planos de execução agentic.
/// Usada exclusivamente em testes unitários.
/// </summary>
public sealed class TestAgentExecutionPlanRepository : IAgentExecutionPlanRepository
{

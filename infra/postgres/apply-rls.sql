...
CREATE POLICY tenant_isolation ON gov_domains
    USING  (get_current_tenant_id() IS NULL OR tenant_id = get_current_tenant_id()::text)
    WITH CHECK (get_current_tenant_id() IS NULL OR tenant_id = get_current_tenant_id()::text);

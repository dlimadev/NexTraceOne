...
### 1. MÓDULO DE LICENSING (NÃO IMPLEMENTADO)

**Severidade: 🔴 CRÍTICA**
**Fonte:** docs/PRODUCT-SCOPE.md, docs/SECURITY.md, docs/PLATFORM-CAPABILITIES.md, analysis-output/modules/licensing-selfhosted-gaps.md

O módulo de Licensing é um requisito estratégico do produto e não possui **nenhuma implementação**. Nenhum diretório, entidade, migração ou endpoint existe.

| Gap | Detalhe | Status |
|-----|---------|--------|
| GAP-LIC-01 | Módulo de Licensing inexistente (zero código) | ❌ Não implementado |
| GAP-LIC-02 | Entitlements por capacidade (tiered licenses) | ❌ Não implementado |
| GAP-LIC-03 | License online e offline | ❌ Não implementado |
| GAP-LIC-04 | Ativação e validação recorrente | ❌ Não implementado |
| GAP-LIC-05 | Heartbeat service | ❌ Não implementado |
| GAP-LIC-06 | Machine fingerprinting | ❌ Não implementado |
| GAP-LIC-07 | Revogação remota | ❌ Não implementado |
| GAP-LIC-08 | Trial/freemium support | ❌ Não implementado |
| GAP-LIC-09 | Enforcement no backend integrado com RBAC | ❌ Não implementado |
| GAP-LIC-10 | Assembly integrity enforcement em runtime (existe verificação mas não enforcement real) | ⚠️ Parcial |

---

### 2. SEED STRATEGY E BOOTSTRAP
...
### 3. DOCUMENTAÇÃO COM INFORMAÇÕES INCORRETAS
...
### 4. CONTRATOS E SERVIÇOS — Gaps Remanescentes
...
### 5. AI E KNOWLEDGE — Gaps Remanescentes
...
### 6. SEGURANÇA — Gaps Remanescentes
...
### 10. OPERAÇÕES E OBSERVABILIDADE — Gaps
...
### 12. FUNCIONALIDADES FUTURAS PLANEADAS (Roadmap)
...
### FASE 6 — Módulo de Licensing (5-10 dias)

**Prioridade: 🔴 CRÍTICA (mas dependente de definição PO)**
**Objetivo:** Implementar o módulo completo de Licensing.

| # | Ação | Gaps Resolvidos | Esforço |
|---|------|-----------------|---------|
| 6.1 | Criar estrutura do módulo: Domain, Application, Infrastructure, API, Contracts | GAP-LIC-01 | 4h |
| 6.2 | Implementar entidades: License, LicenseKey, Entitlement, EntitlementCapability, LicenseActivation | GAP-LIC-01 | 1d |
| 6.3 | Implementar License online validation (server-side) | GAP-LIC-03 | 1d |
| 6.4 | Implementar License offline validation com machine fingerprinting | GAP-LIC-03, GAP-LIC-06 | 1d |
| 6.5 | Implementar entitlements por capacidade/módulo | GAP-LIC-02 | 1d |
| 6.6 | Implementar license heartbeat service | GAP-LIC-05 | 4h |
| 6.7 | Implementar ativação e validação recorrente | GAP-LIC-04 | 4h |
| 6.8 | Implementar revogação remota | GAP-LIC-07 | 4h |
| 6.9 | Implementar trial/freemium support | GAP-LIC-08 | 4h |
| 6.10 | Integrar enforcement com RBAC existente | GAP-LIC-09 | 1d |
| 6.11 | Implementar assembly integrity enforcement real em runtime | GAP-LIC-10 | 4h |
| 6.12 | Implementar assembly/artifact signing (.NET + frontend) | GAP-SEC-03 | 1d |
| 6.13 | Frontend: páginas de gestão de licenças, ativação, entitlements | GAP-LIC-01 | 1d |
| 6.14 | Testes unitários e de integração | GAP-LIC-01 | 1d |
| 6.15 | Migrações e seed data | GAP-LIC-01 | 4h |

**Entregável:** Módulo de Licensing completo, funcional e testado.
...
| **Fase 6** | Módulo de Licensing | 5-10 dias | 🔴 Crítica | 15 |
| **TOTAL** | | **18-32 dias** | | **61 ações** |
...
| Módulos com licensing enforcement | 0% | 100% |
...
2. **Os gaps mais críticos são:** Licensing (módulo inteiro em falta), documentação incorreta, e hardening de frontend.

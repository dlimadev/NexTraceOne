# Identity & Access — Documentação de Páginas Frontend
...
Para cada página do módulo Identity & Access, criar um ficheiro individual nesta pasta com o nome da página (ex.: `login-page.md`, `users-page.md`).

# Identity & Access — Notas de Onboarding para Developers
...
Este documento destina-se a novos developers que precisam compreender e trabalhar no módulo Identity & Access. Deve ser mantido atualizado e servir como ponto de entrada principal.
...
O módulo Identity & Access é o módulo fundacional do NexTraceOne. É responsável por:
...
[A PREENCHER] — Todos os outros módulos do NexTraceOne dependem do Identity & Access para:

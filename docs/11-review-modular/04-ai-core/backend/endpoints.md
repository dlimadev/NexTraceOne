# AI Core — Mapeamento de Endpoints
...
Documentar todos os endpoints do módulo AI Core. Para cada endpoint, preencher a secção completa conforme o template abaixo.

---

## Template de Endpoint

### `[MÉTODO] /api/ai/[recurso]`

| Campo | Valor |
|-------|-------|
| **Endpoint** | [A PREENCHER] (ex.: `/api/ai/[recurso]`) |

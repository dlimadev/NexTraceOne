# AI Core — Notas de Onboarding para Developers
...
Este documento destina-se a novos developers que precisam compreender e trabalhar no módulo AI Core. Deve ser mantido atualizado e servir como ponto de entrada principal.
...
- [A PREENCHER] — Motor de IA central do NexTraceOne
- [A PREENCHER] — Gestão de providers de IA (internos e externos)
- [A PREENCHER] — Model Registry — registo e gestão de modelos
- [A PREENCHER] — Políticas de acesso a IA por utilizador, grupo e persona
- [A PREENCHER] — Gestão de quotas e budgets de tokens
- [A PREENCHER] — Auditoria completa de prompts, respostas e contexto
- [A PREENCHER] — Integração com IA interna local e providers externos
...
Todos os outros módulos do NexTraceOne dependem do AI Core para:

- Aceder a capacidades de IA governadas
- Enviar prompts e receber respostas de forma segura
- Respeitar quotas e políticas de tokens
- Garantir auditoria de toda a interação com IA
- Registar e gerir modelos de IA
...
|---|-------|-------------------|----------------|
| 1 | Registo de modelo | [A PREENCHER] | [A PREENCHER] |
| 2 | Envio de prompt | [A PREENCHER] | [A PREENCHER] |
| 3 | Configuração de política | [A PREENCHER] | [A PREENCHER] |
| 4 | Configuração de provider | [A PREENCHER] | [A PREENCHER] |
| 5 | Consulta de auditoria | [A PREENCHER] | [A PREENCHER] |

# AI Core — Documentação de Páginas Frontend
...
Para cada página do módulo AI Core, criar um ficheiro individual nesta pasta com o nome da página (ex.: `environment-list-page.md`, `environment-detail-page.md`).

# Releases & Change Intelligence — Checklist de Aceite
...
Este checklist deve ser preenchido para confirmar que o módulo Releases & Change Intelligence está pronto para produção. Cada item deve ser verificado e marcado.

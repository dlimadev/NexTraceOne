# Releases & Change Intelligence — Documentação de Páginas Frontend
...
Para cada página do módulo Releases & Change Intelligence, criar um ficheiro individual nesta pasta com o nome da página (ex.: `login-page.md`, `users-page.md`).

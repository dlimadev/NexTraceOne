# Releases & Change Intelligence — Mapeamento de Endpoints
...
Documentar todos os endpoints do módulo Releases & Change Intelligence. Para cada endpoint, preencher a secção completa conforme o template abaixo.

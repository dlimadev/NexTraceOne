# Releases & Change Intelligence — Visão Geral do Módulo
...
O módulo Releases & Change Intelligence é responsável por:
...
| **Módulo frontend** | `src/frontend/src/features/releases-change-intelligence/` |
...
O módulo Releases & Change Intelligence será considerado `DONE` quando:

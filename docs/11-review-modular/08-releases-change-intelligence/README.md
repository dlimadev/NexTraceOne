...
| Campo | Valor |
|-------|-------|
| **Nome do módulo** | Releases & Change Intelligence |
...
- Revisão existente: [`../02-releases-change-intelligence/module-review.md`](../02-releases-change-intelligence/module-review.md)
- Código backend: `src/modules/identityaccess/`
- Código frontend: `src/frontend/src/features/releases-change-intelligence/`

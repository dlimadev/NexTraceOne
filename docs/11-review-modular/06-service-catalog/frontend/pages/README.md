# Service Catalog — Documentação de Páginas Frontend
...
Para cada página do módulo Service Catalog, criar um ficheiro individual nesta pasta com o nome da página (ex.: `catalog-list-page.md`, `service-detail-page.md`).
...
|-------|-------|
| **Nome** | [A PREENCHER] |
| **Rota** | [A PREENCHER] (ex.: `/catalog/services`) |
| **Objetivo** | [A PREENCHER] |
| **Persona principal** | [A PREENCHER] (Engineer, Tech Lead, Architect, etc.) |
| **Personas secundárias** | [A PREENCHER] |
| **Autenticação obrigatória** | [Sim / Não] |
| **Componente React** | [A PREENCHER] (ex.: `ServiceCatalogPage.tsx`) |
...
|------------|------|-----------|-------------|
| [A PREENCHER] | Layout / Form / Table / Modal / Card / Graph | [A PREENCHER] | [Sim / Não] |

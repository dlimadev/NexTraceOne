# Service Catalog — Documentação de Ações Frontend
...
| Campo | Valor |
|-------|-------|
| **Nome da ação** | [A PREENCHER] (ex.: Registar Serviço) |
| **Página de origem** | [A PREENCHER] (ex.: ServiceCatalogPage) |
| **Objetivo** | [A PREENCHER] |
| **Gatilho** | [A PREENCHER] (ex.: Clique no botão "Registar", Submit do formulário) |
| **Permissão necessária** | [A PREENCHER] (ex.: `catalog.services.create`) |
...
| **URL** | [A PREENCHER] (ex.: `/api/catalog/services`) |
...
| Aspecto | Valor |
|---------|-------|
| **Evento de auditoria** | [A PREENCHER] (ex.: `catalog.service.created`) |

# Service Catalog — Mapeamento de Endpoints
...
Documentar todos os endpoints do módulo Service Catalog. Para cada endpoint, preencher a secção completa conforme o template abaixo.

---

## Template de Endpoint

### `[MÉTODO] /api/catalog/[recurso]`

| Campo | Valor |
|-------|-------|
| **Endpoint** | [A PREENCHER] (ex.: `/api/catalog/services`) |

# Service Catalog — Checklist de Aceite
...
Este checklist deve ser preenchido para confirmar que o módulo Service Catalog está pronto para produção. Cada item deve ser verificado e marcado.

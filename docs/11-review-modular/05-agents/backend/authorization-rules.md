...
Documentar todas as regras de autorização do módulo Agents: permissões por página, por ação, restrições por ambiente, por tenant e por capacidade de IA.

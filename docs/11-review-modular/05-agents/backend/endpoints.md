# Agents — Mapeamento de Endpoints
...
Documentar todos os endpoints do módulo Agents. Para cada endpoint, preencher a secção completa conforme o template abaixo.

---

## Template de Endpoint

### `[MÉTODO] /api/agents/[recurso]`

| Campo | Valor |
|-------|-------|
| **Endpoint** | [A PREENCHER] (ex.: `/api/agents/[recurso]`) |

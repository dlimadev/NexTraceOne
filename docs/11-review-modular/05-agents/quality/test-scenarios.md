...
Documentar todos os cenários de teste necessários para o módulo Agents, organizados por categoria.
...
|---|---------|------|------------------|-----------|--------------|--------|
| 1 | Registo de agent no catálogo | Funcional | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
| 2 | Execução de agent com contexto válido | Funcional | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
| 3 | Consulta de resultados de execução | Funcional | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
| 4 | Agendamento de agent | Funcional | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
| 5 | Desativação de agent | Funcional | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
| 6 | [A PREENCHER] | [A PREENCHER] | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
...
|---|---------|-------------|------------------|-----------|--------------|--------|
| 1 | Execução de agent sem permissão | Segurança | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
| 2 | Execução de agent desativado | Negócio | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
| 3 | Agent com provider de IA indisponível | Integração | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
| 4 | Timeout de execução de agent | Performance | [A PREENCHER] | [A PREENCHER] | [Sim / Não] | `NOT_STARTED` |
...
|---|---------|------------------|----------------------|--------------|--------|
| 1 | Utilizador sem permissão tenta aceder gestão de agents | `agents.read` | Redirecionado / 403 | [Sim / Não] | `NOT_STARTED` |

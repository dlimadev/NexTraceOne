# Agents — Documentação de Páginas Frontend
...
Para cada página do módulo Agents, criar um ficheiro individual nesta pasta com o nome da página (ex.: `environment-list-page.md`, `environment-detail-page.md`).
...
|-------|-------|
| **Nome** | [A PREENCHER] |
| **Rota** | [A PREENCHER] (ex.: `/admin/agents`) |

# Environment Management — Visão Geral do Módulo
...
- [A PREENCHER] — Sugestão de configuração por ambiente
- [A PREENCHER] — Análise de drift entre ambientes
- [A PREENCHER] — Validação de promoção
- [A PREENCHER] — Detecção de anomalias de configuração
...
| Aspecto | Descrição |
|---------|-----------|
| **Módulo backend** | `src/modules/environments/` |
| **Módulo frontend** | `src/frontend/src/features/environment-management/` |
...
|---|-------|-----------|---------|-----------|
| 1 | Drift de configuração entre ambientes | `CRITICAL` | [A PREENCHER] | [A PREENCHER] |
| 2 | Promoção não validada para produção | `CRITICAL` | [A PREENCHER] | [A PREENCHER] |
| 3 | Falta de isolamento entre ambientes | `HIGH` | [A PREENCHER] | [A PREENCHER] |
...
O módulo Environment Management será considerado `DONE` quando:

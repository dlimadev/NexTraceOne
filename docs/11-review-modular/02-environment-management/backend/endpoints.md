# Environment Management — Mapeamento de Endpoints
...
Documentar todos os endpoints do módulo Environment Management. Para cada endpoint, preencher a secção completa conforme o template abaixo.

---

## Template de Endpoint

### `[MÉTODO] /api/environments/[recurso]`

| Campo | Valor |
|-------|-------|
| **Endpoint** | [A PREENCHER] (ex.: `/api/environments/[recurso]`) |

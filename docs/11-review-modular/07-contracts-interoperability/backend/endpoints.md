# Contracts & Interoperability — Mapeamento de Endpoints
...
Documentar todos os endpoints do módulo Contracts & Interoperability. Para cada endpoint, preencher a secção completa conforme o template abaixo.

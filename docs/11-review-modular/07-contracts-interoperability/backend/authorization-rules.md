# Contracts & Interoperability — Regras de Autorização
...
Documentar todas as regras de autorização do módulo Contracts & Interoperability: permissões por página, por ação, restrições por ambiente, por tenant e por capacidade de IA.

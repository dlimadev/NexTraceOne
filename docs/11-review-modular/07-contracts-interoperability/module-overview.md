# Contracts & Interoperability — Visão Geral do Módulo
...
O módulo Contracts & Interoperability é responsável por:
...
| **Módulo frontend** | `src/frontend/src/features/contracts-interoperability/` |
...
O módulo Contracts & Interoperability será considerado `DONE` quando:

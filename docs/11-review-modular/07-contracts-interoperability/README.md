...
| Campo | Valor |
|-------|-------|
| **Nome do módulo** | Contracts & Interoperability |
...
- Revisão existente: [`../02-contracts-interoperability/module-review.md`](../02-contracts-interoperability/module-review.md)
- Código backend: `src/modules/identityaccess/`
- Código frontend: `src/frontend/src/features/contracts-interoperability/`

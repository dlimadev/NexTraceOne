# Contracts & Interoperability — Documentação de Páginas Frontend
...
Para cada página do módulo Contracts & Interoperability, criar um ficheiro individual nesta pasta com o nome da página (ex.: `login-page.md`, `users-page.md`).
...
|-------|-------|
| **Nome** | [A PREENCHER] |
| **Rota** | [A PREENCHER] (ex.: `/admin/users`) |
...
| **Componente React** | [A PREENCHER] (ex.: `UsersPage.tsx`) |

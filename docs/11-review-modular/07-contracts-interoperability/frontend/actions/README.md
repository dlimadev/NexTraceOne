# Contracts & Interoperability — Documentação de Ações Frontend
...
| Campo | Valor |
|-------|-------|
| **Nome da ação** | [A PREENCHER] (ex.: Criar Utilizador) |
| **Página de origem** | [A PREENCHER] (ex.: UsersPage) |
| **Objetivo** | [A PREENCHER] |
| **Gatilho** | [A PREENCHER] (ex.: Clique no botão "Criar", Submit do formulário) |
| **Permissão necessária** | [A PREENCHER] (ex.: `users.create`) |
...
| **URL** | [A PREENCHER] (ex.: `/api/identity/users`) |
...
| Aspecto | Valor |
|---------|-------|
| **Evento de auditoria** | [A PREENCHER] (ex.: `user.created`) |

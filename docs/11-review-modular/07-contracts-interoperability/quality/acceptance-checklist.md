# Contracts & Interoperability — Checklist de Aceite
...
Este checklist deve ser preenchido para confirmar que o módulo Contracts & Interoperability está pronto para produção. Cada item deve ser verificado e marcado.
...
- [ ] Eventos de login registados
- [ ] Eventos de logout registados
- [ ] Eventos de criação/edição/remoção de utilizadores registados
- [ ] Eventos de alteração de permissões registados
- [ ] Eventos de MFA registados
- [ ] Eventos de break glass registados
- [ ] Eventos de JIT access registados
...
- [ ] Métricas de autenticação expostas
- [ ] Métricas de autorização expostas

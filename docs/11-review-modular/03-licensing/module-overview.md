# Licensing — Visão Geral do Módulo
...
- [A PREENCHER] — Análise de uso por funcionalidade
- [A PREENCHER] — Previsão de necessidade de licença
- [A PREENCHER] — Sugestão de plano ideal
- [A PREENCHER] — Detecção de abuso de licença
...
| Aspecto | Descrição |
|---------|-----------|
| **Módulo backend** | `src/modules/licensing/` |
| **Módulo frontend** | `src/frontend/src/features/licensing/` |
...
|---|-------|-----------|---------|-----------|
| 1 | Bypass de verificação de licença | `CRITICAL` | [A PREENCHER] | [A PREENCHER] |
| 2 | Funcionalidades premium acessíveis sem licença | `CRITICAL` | [A PREENCHER] | [A PREENCHER] |
| 3 | Falta de enforcement consistente em todas as camadas | `HIGH` | [A PREENCHER] | [A PREENCHER] |
...
O módulo Licensing será considerado `DONE` quando:

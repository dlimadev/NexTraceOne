# Licensing — Mapeamento de Endpoints
...
Documentar todos os endpoints do módulo Licensing. Para cada endpoint, preencher a secção completa conforme o template abaixo.

---

## Template de Endpoint

### `[MÉTODO] /api/licensing/[recurso]`

| Campo | Valor |
|-------|-------|
| **Endpoint** | [A PREENCHER] (ex.: `/api/licensing/[recurso]`) |

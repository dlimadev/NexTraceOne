...
| `GetAutomationValidation` | OperationalIntelligence | Retorna sempre `Array.Empty<ValidationCheckDto>()` | Stub |
| `GetAutomationWorkflow` | OperationalIntelligence | Preconditions e ExecutionSteps vazios | Stub |
| `GetServiceFinOps` | Governance | EfficiencyIndicators vazio, ReliabilityScore=0 | Stub |
| `ValidateContractIntegrity` | Catalog | Protobuf & GraphQL retornam stub | Stub |
...
- **Handlers parcialmente stub:** ~~5+~~ 4 (GetExecutiveDrillDown enriched)

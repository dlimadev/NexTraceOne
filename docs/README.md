...
| [security/](./security/) | Security details (hardening, key rotation, endpoint audit) |
...
| [observability/](./observability/) | Observability docs (drift detection, ingestion, troubleshooting) |

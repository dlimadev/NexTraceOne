# Environment Management — Documentação de Ações Frontend
...
| **Permissão necessária** | [A PREENCHER] (ex.: `environments.create`) |
...
| **URL** | [A PREENCHER] (ex.: `/api/environments/[recurso]`) |

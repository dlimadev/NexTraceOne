...
{
    /// <inheritdoc />
    public partial class AddAuditComplianceEntities : Migration
    {
        /// <inheritdoc />
        ...
        {
            migrationBuilder.DropTable(name: "aud_audit_chain_links");
            migrationBuilder.DropTable(name: "aud_campaigns");
            migrationBuilder.DropTable(name: "aud_compliance_results");
            migrationBuilder.DropTable(name: "aud_retention_policies");
            migrationBuilder.DropTable(name: "aud_compliance_policies");
            migrationBuilder.DropTable(name: "aud_audit_events");
        }
    }
}

...
- **Estado:** 11 Designer files em falta (requerem `dotnet ef` com PostgreSQL ativo)
- **Módulos afectados:**
  ...
  - OperationalIntelligence (2): `P51_PredictiveIntelligence`, `W01_TelemetryStoreFoundation`
